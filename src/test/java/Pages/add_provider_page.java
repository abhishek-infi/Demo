...
public class add_provider_page extends start {
	...
	By Type = By.xpath(".//*[@id='createProvider']/div/div/div/div/div[2]/div[3]/div/div/div[2]/div");
	...
	By Register_button = By.xpath(".//*[@id='vmwareForm']/div[4]/div[2]/button[1]");
    ...
    public add_provider_page ProvidernameAs(String pname) throws InterruptedException   {
    	Thread.sleep(500);
    	driver.findElement(Provider_name).sendKeys(pname);
        return  this;
    }
    
    public add_provider_page DescriptionAs(String description) throws InterruptedException   {
    	Thread.sleep(500);
    	driver.findElement(Description).sendKeys(description);
        return  this;
    }
    public add_provider_page hostnameAs(String host) throws InterruptedException   {
    	Thread.sleep(500);
    	driver.findElement(hostname).sendKeys(host);
        return  this;
    }
    
    public add_provider_page usernameAs(String username) throws InterruptedException   {
    	Thread.sleep(500);
    ...
    public add_provider_page PasswordAs(String pass) throws InterruptedException   {
    	Thread.sleep(500);
        WebElement element = null;
    	WebDriverWait wait = new WebDriverWait(driver, 30);
    	element = wait.until(ExpectedConditions.visibilityOfElementLocated(Password));
    ...
    WebElement element =null;
    WebDriverWait wait = new WebDriverWait(driver, 30);
    element = wait.until(ExpectedConditions.elementToBeClickable(Register_button));
